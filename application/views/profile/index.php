...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-10 col-md-5 col-lg-4 col-xl-2 ml-5 offset-sm-1 offset-md-0 offset-lg-0 offset-xl-0">
      ...
      <img src="<?= $imageSrc ?>" alt="Profile Image" style="width: 300px; height: 300px; cursor: pointer; border-radius: 50%; border: 5px solid #BE110E;" id="uploadImage">
    </div>
    <!-- right -->
    <div class="col-sm-10 col-md-6 offset-sm-1">
      <h1 class="h3 text-white rounded mt-1 mb-5 p-3" style="background: linear-gradient(180deg, #BE110E, #630908); ">Librarian Data</h1>
      <table class="table">
        <tbody>
          <tr>
            <?php 
