              ...
              <div class="col-lg-6 m-auto">
                <div class="card" style ="    border-radius: 15px;">          
                  ...
                  <div class="card-body d-flex flex-wrap p-4">                
                    ...
                    <button style="background: linear-gradient(180deg, #BE110E, #630908); border:none; padding: 5px; border-radius: 15px;" type="submit" class="btn btn-success btn-icon-split mt-4 w-100">
