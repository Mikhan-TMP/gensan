...
<!-- Begin Page Content -->
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-9">
                    <a href="<?= base_url('master/a_users'); ?>" class="btn btn-icon-split mb-4 shadow-sm text-light"
                        ...
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody style="color: #272727;">
                                ...
                                <tr>
                                    ...
                                    <td class=" align-middle"> <?= $dt['u_lname'] . ', ' . $dt['u_fname']; ?> </td>
                                    <!-- <td class=" align-middle text-center"> Librarian   </td> -->
                                    <td class="text-center align-middle"
                                        style="display: flex; align-items: center; gap: 10px">
                                        <a class="editBtn" href="<?= base_url('master/e_users/') . $dt['e_id'] ?>"
                                            style="text-decoration: none" tooltip="Edit">
                                            <!-- edit -->
                                        ...
                                        <!-- delete -->
                                        <a class="bin-button" href="javascript:void(0);"
                                            onclick="confirmDelete(<?= $dt['e_id'] ?>)" tooltip="Delete">
        ...
        <script>
          function confirmDelete(id) {
              Swal.fire({
                  title: 'Are you sure?',
                  text: "Deleted Librarian will be lost forever. Do you still want to delete?",
                  icon: 'warning',
                  ...
                  if (result.isConfirmed) {
                      window.location.href = "<?= base_url('master/d_users/') ?>" + id;
                  }
              })
          }
        </script>